// START SERVER AFTER INITIALISING GLOBAL VARIABLES
// TODO: this approach is not working correctly
(async () =>{
  // node imports
  ...
  // parse to array
  let users = security.parseArray(userBuffer) || [];
  let ips = security.parseArray(ipBuffer) || [];
