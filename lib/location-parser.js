/**
 * Helper that onverts cities in a tsv file into an array of locations instances
 * @see Location
 */
...
/**
 * converts a tsv row into a Location instance
 */
...
module.exports = {
  ...
  load: function (dataFile, cb) {
    ...
    // streaming the tsv, we will get an array of `Location`s
    input
      .on('error', cb)
      .pipe(parser)
