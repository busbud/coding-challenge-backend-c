 ...
 * 
 * TextScore is based on levenshstein score.
 * Disance score is based on a inversed square root function
 * that returns 1 when the 2 points are equal and 0 when distance is 500km
 */
...
function getLevenhSteinBasedScore(str1, str2) {
  ...
  // it is not bad... but not perfect... because levenshtein score is low is str2.length << str1 ("Mtl" example)
