 ...
 * Store class
 *
 * Memory store that contains all the location instances
 * and allow to find suggestions based on a query
 */
...
module.exports = {
  // exposing data for debugging purposes only
  _data: data,
  
  // allow to force a reload.
  // used by the tests. Could be used to force a reload while in production
  _reset: function () {
    loaded = false;
    isLoading = false;
  },

  // loads the locations only once
