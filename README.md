...
- API traffic control is achieved through the Node package `express-rate-limit`. The set limit is 200 requests per 15 minutes window. Future versions of the application would make this configurable through environment variables. 
